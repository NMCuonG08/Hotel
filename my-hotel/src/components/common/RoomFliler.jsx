...
const RoomFliler = ({ data, setFilteredDates }) => {
    ...
    const handleSelectChange = (e) => {
        ...
        setFilteredDates(filteredRooms);
    };
    ...
    return (
        <div className="input-group mb-3">
            ...
            <button className="btn btn-success" type="button" onClick={clearFilter}>Clear Filter</button>
        </div>
    );
};
