...
const Title = () => {
  return (
    <div>
        <div className="container-fluid mt-5 mb-5 rounded-4  " style={{ height: "160px", backgroundColor: "#e61e43" }}>
                    <Row className="d-flex justify-content-center">
                        <Col md={3} className="">
                            <h3 className='mt-5 ms-4' style={{ color: "white" }} >Tìm và đặt nơi lưu trú hoàn hảo </h3>
                        </Col>
                        <Col md={3}>
                            <div className="container mt-3 rounded-4" style={{ height: "130px", backgroundColor: "#a1122c", display: "flex", justifyContent: "center", alignItems: "center" }}>
