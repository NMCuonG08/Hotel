...
import { getHotelByID, getHotelImages, getRoomByID, getRoomImagesByRoomID } from '../../utils/APIFunctions'
                ...
                <Form style={{fontSize : "16px"}} className="w-100" >
                  ...
                  <Form.Group>
                    ...
                    <Row style={{fontSize : "30px"}} >
                      ...
                      <button className="btn btn-success mt-3 mb-3 " type="submit" onClick={handleSubmit} >Tiếp tục thanh toán</button>
                    ...
                    <Carousel indicators={false}>
                                    {[...Array(Math.ceil(images.length / 4))].map((_, index) => (
                                        <Carousel.Item key={index}>
                                            <Row>
                                                {images.slice(index * 1, index * 1 + 1).map((image, imgIndex) => (
                                                    <Col className=""  key={imgIndex}>
